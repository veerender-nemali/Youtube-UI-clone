export const key = "AIzaSyDyOSIf7xpawGKMaFBZmRG6xblUfPGM1IA"; //A
...
export const navSvgLinkHandler = (linkName, navigatedTo) => {
  const navLinkSvgs = {
    home: (
      <svg
